...
const Benefits = () => {
  return (
    <section className="py-20 px-6 md:px-12 bg-gradient-to-b from-techstars-black to-techstars-slate/90 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-techstars-white">Member Benefits</h2>
        </div>
        ...
        <div className="mb-10">
          <div className="flex items-center gap-2 mb-6 bg-techstars-phosphor/20 p-3 rounded-lg inline-block">
            ...
            <h3 className="text-2xl font-semibold text-techstars-white">Wednesdays</h3>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="bg-techstars-black/50 border-none shadow-xl shadow-techstars-slate/10 hover:shadow-techstars-phosphor/20 transition-all group hover:translate-y-[-5px] backdrop-blur-sm">
              ...
              <CardContent>
                <p className="text-techstars-white/80">
